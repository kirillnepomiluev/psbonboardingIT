...
class ProjectPageWeb extends StatelessWidget {
  ...
  Widget _leftBody() {
    return Column(
      children: [
        WebNavigationMenu(
          activeItem: NavigationItem.projects,
        ),
        Container(
          height: 10,
        ),
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          _boxForHeaderAndDescription(
              logo: false,
              description: 'Веб-приложение для сотрудников банка.',
              header: 'Результаты проекта'),
          Container(
            height: 15,
          ),
  ...
  Widget _boxForHeaderAndDescription(
      {String header = 'Наименование и тип',
      String description =
          'Разработка программного решения для онбординга новых ИТ-специалистов банка.',
      bool logo = true}) {
    return Container(
